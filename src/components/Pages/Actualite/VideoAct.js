        ...
        <Container >
           ...
           <Row >
            ...
            <Row style={{display:"flex"}}>
                <p style={{marginTop:"35px",fontSize:"18px",marginLeft:"5px",color:"#797D7F",cursor:"pointer"}}><b>A la une</b></p>
                <GrCaretNext style={{marginLeft:"-510px",fontSize:"20px",color:"#CACFD2",marginTop:"-38px",cursor:"pointer"}}/>
                <p style={{marginLeft:"170px",marginTop:"-42px",cursor:"pointer"}}>TOUT REGARDER</p>
